# Gotchas (layer 3 — project-specific)

Traps that look like mistakes but are intentional, or non-obvious facts that cost a
session time to rediscover. **Add a line the moment one is found.** This file is
allowed to be a flat, growing list — it is the highest-value document in the
project for AI-assisted work.
